(function() {
    function o(n) {
        ...
        if (!i.requireAce || !i.requireAce.packaged) r.original = i.requireAce, i.requireAce = r, i.requireAce.packaged = !0
    }
    var ACE_NAMESPACE = "",
        e = function() {
            return this
    ...
    var u = function() {
        ...
        a = {
            ...
            suffix: ".js",
            $moduleUrls: {
                "ace/mode/css_worker": "https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.9/worker-css.js"
            }
        };
    t.get = function(e) {
        ...
        console.log("Unsupported require from ace:", e)
        var n = e.split("/");
        t = t || n[n.length - 2] || "";
        var r = t == "snippets" ? "/" : "-",
            i = n[n.length - 1];
    ...
    e("./worker/worker_client"), e("./keyboard/hash_handler"), e("./placeholder"), e("./multi_select"), e("./mode/folding/fold_mode"), e("./theme/textmate"), e("./ext/error_marker"), t.config = e("./config"), t.requireAce = e, typeof define == "function" && (t.define = define), t.edit = function(e) {
        if (typeof e == "string") {
            var n = e;
...
(function() {
    window.requireAce(["ace/ace"], function(a) {
        if (a) {
            a.config.init(true);
